...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Фестиваль футзалу у Вінниці</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="htttp://www.binarytheme.com">VINNYTSIA FUTSAL FEST</a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#contact-sec">Контакти</a>
                    </li>
    ...
    <div class="container" >
        <div class="row ">
            <div class="col-md-9 col-sm-9">
                <h1 class="head-main">Vinnytsia futsal fest</h1>
                <span class="head-sub-main">Фестиваль футзалу у Вінниці</span>
                <div class="head-last">

                    Офіційний сайт фестивалю футзалу у Вінниці
                </div>

            </div>
               <div class="col-md-3 col-sm-3">
                   <div class="div-trans text-center">
                       <h3>Отримати інформацію </h3>
                        <form>
                       
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" required="required" placeholder="Ім'я">
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <textarea name="message" id="Textarea1" required="required" class="form-control" rows="3" placeholder="Повідомлення"></textarea>
                                </div>
                                <div class="form-group">
